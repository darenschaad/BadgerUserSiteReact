  ...
  render() {
    ...
    return(
      <div>
        <NavBar />
        <h1>Categories</h1>
        <div className="category-individual" value={0} onClick={() => this.goToCategory(0)} >
        ...
        <div className="category-individual" value={100} onClick={() => this.goToCategory(100)} >
        ...
        <div className="category-individual" value={200} onClick={() => this.goToCategory(200)} >
        ...
        <div className="category-individual" value={300} onClick={() => this.goToCategory(300)} >
        ...
        <div className="category-individual" value={400} onClick={() => this.goToCategory(400)} >
        ...
        <div className="category-individual" value={500} onClick={() => this.goToCategory(500)} >
        ...
        <div className="category-individual" value={600} onClick={() => this.goToCategory(600)} >
        ...
        <div className="category-individual" value={700} onClick={() => this.goToCategory(700)} >
        ...
        <div className="category-individual" value={800} onClick={() => this.goToCategory(800)} >
        ...
        <div className="category-individual" value={900} onClick={() => this.goToCategory(900)} >
